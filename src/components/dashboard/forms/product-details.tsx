    ...
    <AlertDialog>
      <Card className="w-full">
        <CardHeader>
          <CardTitle>
            {isNewVariantPage
              ? `Ajouter une nouvelle variante à ${data.name}`
              : "Créer un nouveau produit"}
          </CardTitle>
          <CardDescription>
            {data?.productId && data.variantId
              ? `Mettre à jour les informations du produit ${data?.name}.`
              : " Créons un produit. Vous pourrez modifier le produit plus tard depuis la page du produit."}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <div className="flex items-center gap-10 py-14">
                ...
                <div className="border-r pr-10">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="ml-14">Image de la variante</FormLabel>
                        <FormControl>
                          <ImageUpload
                            dontShowPreview
                            type="profile"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="relative flex-1">
                        <FormLabel>Mots-clés du produit</FormLabel>
                        <FormControl>
                          <ReactTags
                            handleAddition={handleAddition}
                            handleDelete={() => {}}
                            placeholder="Mots-clés (ex: veste d'hiver, chaud, élégant)"
                            classNames={{
                              tagInputField:
