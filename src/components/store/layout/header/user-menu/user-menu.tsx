              ...
              <div className="max-w-[calc(100vh-180px)] text-main-secondary overflow-y-auto overflow-x-hidden pt-0 px-2 pb-4">
                <ul className="grid grid-cols-3 gap-2 py-2.5 ^px-4 w-full">
                  <li className="grid place-items-center">
                    <Link href="/profile/orders" className="space-y-2">
                      <div className="w-14 h-14 rounded-full p-2 grid place-items-center bg-gray-100 hover:bg-gray-200">
                        <span className="text-gray-500"><OrderIcon /></span>
                      </div>
                      <span className="block text-xs">Mes commandes</span>
                    </Link>
                  </li>
                  <li className="grid place-items-center">
                    <Link href="/profile/messages" className="space-y-2">
                      <div className="w-14 h-14 rounded-full p-2 grid place-items-center bg-gray-100 hover:bg-gray-200">
                        <span className="text-gray-500"><MessageIcon /></span>
                      </div>
                      <span className="block text-xs">Messages</span>
                    </Link>
                  </li>
                  <li className="grid place-items-center">
                    <Link href="/profile/wishlist" className="space-y-2">
                      <div className="w-14 h-14 rounded-full p-2 grid place-items-center bg-gray-100 hover:bg-gray-200">
                        <span className="text-gray-500"><WishlistIcon /></span>
                      </div>
                      <span className="block text-xs">Liste de souhaits</span>
                    </Link>
                  </li>
                </ul>
